...
- 확인 환경: Mesen 2 (스테이지 플레이, 결과 보고·스코어 화면까지 확인)
...
| CRC32 | `8FE18F83` |
| MD5 | `436583906fb1861c5e04a0fd992abd0b` |
| SHA1 | `3cf40436a685ee77cf7221fc7ce7fec231931794` |
...
- 기록 화면(기록 보기·삭제), EXPERT 레벨 안내 등 일부 그림 글씨는 게임 화면에서 확인하지 못했습니다. 이상한 부분은 이슈로 알려주세요.
